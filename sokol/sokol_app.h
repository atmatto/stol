...
/*
    ...
    via the following Windows-specific sapp_desc tags:
...
_SOKOL_PRIVATE void _sapp_d3d11_create_device_and_swapchain(void) {
    ...
    if (!SUCCEEDED(hr)) {
        ...
        // These tags must be removed, or the Windows 10 SDK must be installed.
...
_SOKOL_PRIVATE void _sapp_d3d11_present(bool do_not_wait) {
    ...
    if (_sapp.win32.is_win10_or_greater && do_not_wait) {
        ...
        */
        tags = DXGI_PRESENT_DO_NOT_WAIT;
    }
    _sapp_dxgi_Present(_sapp.d3d11.swap_chain, (UINT)_sapp.swap_interval, tags);
}
...
void DeviceResources::CreateDeviceResources() {
    ...
    HRESULT hr = D3D11CreateDevice(
        ...
        creationFlags,              // Set debug and Direct2D compatibility tags.
